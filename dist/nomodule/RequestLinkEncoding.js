...
const ETHEREUM_SUPPORTED_CONTRACTS = {
    [exports.EthereumChain.ETHEREUM_MAINNET]: {
        [exports.Currency.USDC]: '0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d',
    },
    [exports.EthereumChain.ETHEREUM_GOERLI_TESTNET]: {
        [exports.Currency.USDC]: '0xde637d4c445ca2aae8f782ffac8d2971b93a4998',
    },
    [exports.EthereumChain.POLYGON_MAINNET]: {
        [exports.Currency.USDC]: '0x2791bca1f2de4661ed88a30c99a7a9449aa84174',
    },
    [exports.EthereumChain.POLYGON_MUMBAI_TESTNET]: {
        [exports.Currency.USDC]: '0x0fa8781a83e46826621b3bc094ea2a0212e71b23',
    },
};
...
function parseRequestLink(requestLink, options = {}) {
    ...
    if ([...ETHEREUM_SUPPORTED_NATIVE_CURRENCIES, exports.Currency.USDC].some((currency) => currencies.includes(currency))
...
function getEthereumBlockchainName(chainIdOrNativeCurrency) {
    switch (chainIdOrNativeCurrency) {
        ...
        case exports.EthereumChain.ETHEREUM_GOERLI_TESTNET:
        case exports.Currency.ETH:
            return EthereumBlockchainName.ETHEREUM;
        case exports.EthereumChain.POLYGON_MAINNET:
        case exports.EthereumChain.POLYGON_MUMBAI_TESTNET:
        case exports.Currency.MATIC:
