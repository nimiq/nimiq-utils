...
exports.FiatApiSupportedCryptoCurrency = void 0;
...
})(exports.FiatApiSupportedCryptoCurrency || (exports.FiatApiSupportedCryptoCurrency = {}));
...
//     }
// }
exports.FiatApiSupportedFiatCurrency = void 0;
...
})(exports.FiatApiSupportedFiatCurrency || (exports.FiatApiSupportedFiatCurrency = {}));
exports.FiatApiBridgedFiatCurrency = void 0;
(function (FiatApiBridgedFiatCurrency) {
    FiatApiBridgedFiatCurrency["CRC"] = "crc";
})(exports.FiatApiBridgedFiatCurrency || (exports.FiatApiBridgedFiatCurrency = {}));
const API_URL = 'https://api.coingecko.com/api/v3';
const COINGECKO_COIN_IDS = {
    [exports.FiatApiSupportedCryptoCurrency.NIM]: 'nimiq-2',
    [exports.FiatApiSupportedCryptoCurrency.BTC]: 'bitcoin',
    [exports.FiatApiSupportedCryptoCurrency.ETH]: 'ethereum',
    [exports.FiatApiSupportedCryptoCurrency.USDC]: 'usd-coin',
};
...
async function getExchangeRates(cryptoCurrencies, vsCurrencies) {
    ...
    for (const vsCurrency of vsCurrencies) {
        if (!Object.values(exports.FiatApiBridgedFiatCurrency).includes(vsCurrency))
            continue;
        bridgedCurrencies.push(vsCurrency);
        switch (vsCurrency) {
            case exports.FiatApiBridgedFiatCurrency.CRC: {
                // Use USD as the intermediate currency
                if (!vsCurrencies.includes(exports.FiatApiSupportedFiatCurrency.USD)) {
                    vsCurrencies.push(exports.FiatApiSupportedFiatCurrency.USD);
                }
        ...
        for (const price of Object.entries(prices)) {
            ...
            switch (bridgedCurrency) {
                case exports.FiatApiBridgedFiatCurrency.CRC: {
                    ...
                    const usdPrice = vsPrices[exports.FiatApiSupportedFiatCurrency.USD];
...
to) {
    ...
    if (Object.values(exports.FiatApiBridgedFiatCurrency).includes(vsCurrency)) {
        ...
        switch (bridgedCurrency) {
            case exports.FiatApiBridgedFiatCurrency.CRC: {
                // Use USD as the intermediate currency
                vsCurrency = exports.FiatApiSupportedFiatCurrency.USD;
...
exports.getHistoricExchangeRates = getHistoricExchangeRates;
exports.getHistoricExchangeRatesByRange = getHistoricExchangeRatesByRange;
